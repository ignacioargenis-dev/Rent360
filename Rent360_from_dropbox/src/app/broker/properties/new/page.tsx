  ...
  const validateStep = (currentStep: number) => {
    ...
    switch (currentStep) {
      case 1:
        ...
        if (!formData.contractType) newErrors.contractType = 'El tipo de contrato es requerido';
        break;
      case 2:
      ...
      case 3:
        ...
        if (formData.bedrooms < 0) newErrors.bedrooms = 'El número de dormitorios no puede ser negativo';
        if (formData.bathrooms < 0) newErrors.bathrooms = 'El número de baños no puede ser negativo';
      ...
      case 4:
        ...
        if (!formData.ownerEmail.trim()) newErrors.ownerEmail = 'El email del propietario es requerido';
        if (!formData.ownerPhone.trim()) newErrors.ownerPhone = 'El teléfono del propietario es requerido';
        break;
    }
