  ...
  const handleAddPaymentMethod = async () => {
    try {
      ...
      const newMethod: PaymentMethod = {
        ...
        bank: newPaymentMethod.type === 'bank_transfer' ? newPaymentMethod.bank : undefined,
        accountType: newPaymentMethod.type === 'bank_transfer' ? newPaymentMethod.accountType : undefined,
        accountNumber: newPaymentMethod.type === 'bank_transfer' ? `****${newPaymentMethod.accountNumber.slice(-4)}` : undefined,
