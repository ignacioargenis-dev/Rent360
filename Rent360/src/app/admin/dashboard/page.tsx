      ...
      try {
        ...
        if (usersResponse.ok) {
          ...
          if (propertiesResponse.ok) {
            ...
            const activeContracts = propertiesData.properties.filter((p: any) => p.status === 'rented').length;
            ...
            if (ticketsResponse.ok) {
              ...
              const monthlyRevenue = propertiesData.properties
              ...
              setRecentUsers(usersData.users.slice(0, 4).map((user: any) => ({
                id: user.id,
                name: user.name,
                email: user.email,
              ...
              usersData.users.slice(0, 3).forEach((user: any) => {
                activities.push({
                  ...
                  description: `${user.name} se registró como ${getRoleDisplayName(user.role)}`,
                  date: user.createdAt,
              ...
              propertiesData.properties.slice(0, 3).forEach((property: any) => {
                activities.push({
                  id: `property-${property.id}`,
                  type: 'property' as const,
                  title: 'Nueva propiedad publicada',
                  description: `${property.title} publicada`,
              ...
              ticketsData.tickets
                ...
                .forEach((ticket: any) => {
                  activities.push({
                    ...
                    title: 'Ticket de soporte crítico',
        ...
        <div className="mb-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <QuickActionCard
              icon={Ticket}
              title="Soporte"
              description="Revisa los tickets de soporte"
              href="/admin/tickets"
              color="red"
