...
const mockMaintenanceRequests: MaintenanceRequest[] = [
  ...
  },
  {
    id: '5',
    propertyId: '5',
    propertyName: 'City View Apartment 312',
    title: 'Garbage Disposal Not Working',
    description: 'Kitchen garbage disposal stopped working',
    category: 'Appliance',
    priority: 'medium',
    status: 'pending',
    estimatedCost: 120,
...
const mockContractors: Contractor[] = [
  ...
  },
  {
    ...
    email: 'tom.wilson@general.com',
    status: 'available',
    completedJobs: 28,
    totalEarnings: 22100,
    joinDate: '2023-06-01',
    verified: true,
    specialties: ['Structural', 'Carpentry', 'Painting']
  }
]
...
const mockMaintenanceStats: MaintenanceStats = {
  ...
  topCategories: [
    ...
    { category: 'HVAC', count: 32 },
    { category: 'Appliance', count: 25 },
    { category: 'Structural', count: 16 }
  ],
  monthlyTrend: [
    { month: 'Sep', count: 12 },
    { month: 'Oct', count: 15 },
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Oversee all maintenance requests and contractors across the platform</p>
        </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Contractor Utilization</CardTitle>
                <Users className="h-4 w-4 text-muted-foreground" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">{stats.contractorUtilization}%</div>
                <p className="text-xs text-muted-foreground">
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm">{formatDate(contractor.joinDate)}</p>
                    </div>
                  </div>
