...
import { Eye, CreditCard, AlertTriangle, Search, Filter, Download } from 'lucide-react';
...
export default function AdminPendingPaymentsPage() {
  ...
  const filteredPayments = payments.filter(payment => {
    const matchesSearch = payment.contract?.property?.title.toLowerCase().includes(searchTerm.toLowerCase()) ||
                ...
                {filteredPayments.map((payment) => {
                  ...
                  return (
                    <TableRow key={payment.id}>
                      ...
                      <TableCell>
                        <div>
                          <div className="font-medium">{payment.contract?.property?.title}</div>
                      ...
                      <TableCell>
                        <div>
                          <div className="font-medium">{payment.contract?.tenant?.name}</div>
                          <div className="text-sm text-gray-500">
