...
export default function RunnerPerformanceReport() {
  ...
  const getPerformanceBadge = (value: number, type: 'rating' | 'percentage' | 'time') => {
    if (type === 'rating') {
      if (value >= 4.5) return <Badge className="bg-green-100 text-green-800">Excelente</Badge>;
      if (value >= 4.0) return <Badge className="bg-blue-100 text-blue-800">Bueno</Badge>;
      if (value >= 3.5) return <Badge className="bg-yellow-100 text-yellow-800">Regular</Badge>;
      return <Badge className="bg-red-100 text-red-800">Mejorable</Badge>;
    } else if (type === 'percentage') {
      if (value >= 90) return <Badge className="bg-green-100 text-green-800">Excelente</Badge>;
      if (value >= 80) return <Badge className="bg-blue-100 text-blue-800">Bueno</Badge>;
      if (value >= 70) return <Badge className="bg-yellow-100 text-yellow-800">Regular</Badge>;
      return <Badge className="bg-red-100 text-red-800">Mejorable</Badge>;
    } else {
      if (value <= 15) return <Badge className="bg-green-100 text-green-800">Excelente</Badge>;
      if (value <= 20) return <Badge className="bg-blue-100 text-blue-800">Bueno</Badge>;
      if (value <= 25) return <Badge className="bg-yellow-100 text-yellow-800">Regular</Badge>;
