    ...
    const loadPredictionData = async () => {
      try {
        ...
        const riskAssessmentData = [
          { propertyId: 'PROP001', address: 'Av. Principal 123', riskLevel: 'high', probability: 78, factors: ['Mora en pagos', 'Múltiples reclamos'] },
          { propertyId: 'PROP002', address: 'Calle Secundaria 456', riskLevel: 'medium', probability: 45, factors: ['Historial de mantenimiento'] },
          { propertyId: 'PROP003', address: 'Plaza Central 789', riskLevel: 'low', probability: 12, factors: ['Sin incidentes'] }
        ];

        const churnPredictionData = [
          { userId: 'USER001', userName: 'Juan Pérez', riskLevel: 'high', probability: 82, reasons: ['Inactividad prolongada', 'Sin contratos activos'] },
          { userId: 'USER002', userName: 'María García', riskLevel: 'medium', probability: 55, reasons: ['Última actividad hace 30 días'] },
          { userId: 'USER003', userName: 'Carlos López', riskLevel: 'low', probability: 15, reasons: ['Usuario activo'] }
        ];
